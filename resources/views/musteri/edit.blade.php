            ...
            if ((file = this.files[0])) {
                ...
                img.onload = function () {
                    ...
                    if  (this.width != 1080 || this.height != 1080) {
                        $('#error_foto').html('<label class="text-danger">Lütfen 1080 X 1080px Oranında Fotoğraf Yükleyiniz</label>');
            ...
            if ((file = this.files[0])) {
                ...
                img.onload = function () {
                    ...
                    if (this.width != 1900 || this.height != 260) {
                        ...
                        $('#error_header').html('<label class="text-danger">Lütfen 1900 X 260px boyutlarında yükleyiniz</label>');
