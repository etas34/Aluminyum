                ...
                <div class="row">
                    ...
                    <div class="col-md-12">
                        <div class="card card-primary">
                            ...
                            <form action="{{route('urun.update',$urun)}}" method="post" autocomplete="off"  enctype="multipart/form-data">
                                {{csrf_field()}}
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="form-group col-md-12">
                                        ...
                                        <input type="text"  name="ad" class="form-control" value="{{$urun->ad}}" required>
                                    </div>
